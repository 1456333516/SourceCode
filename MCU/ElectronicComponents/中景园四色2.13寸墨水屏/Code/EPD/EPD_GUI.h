...
void EPD_ShowChar(uint16_t x,uint16_t y,uint16_t chr,uint16_t size1,uint8_t fc,uint8_t bc);                         //显示字符
void EPD_ShowString(uint16_t x,uint16_t y,uint8_t *chr,uint16_t size1,uint8_t fc,uint8_t bc);                       //显示字符串
void EPD_ShowNum(uint16_t x,uint16_t y,uint32_t num,uint16_t len,uint16_t size1,uint8_t fc,uint8_t bc);                  //显示数字
...
void EPD_ShowPicture(uint16_t x,uint16_t y,uint16_t sizex,uint16_t sizey,const uint8_t BMP[],uint16_t fc,uint16_t bc);		//显示单色图片    
